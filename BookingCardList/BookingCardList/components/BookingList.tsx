...
import { BookingCardVM, StatusActionKey, TabInfo } from "../types";
...
export interface BookingListProps {
    ...
    lockedStatusIds?: Set<string>;
    customStatusName?: string;
    onLoadMore: () => void;
    onOpen: (bookingId: string) => void;
    onOpenMaps: (bookingId: string) => void;
    onChangeStatus: (bookingId: string, action: StatusActionKey) => void;
    t: (key: string, fallback: string) => string;
}

export const BookingList: React.FC<BookingListProps> = (props) => {
    const styles = useStyles();
    const { tabs, activeTab, bookingIds, details, loading, error, hasNextPage, statusBusy, t } =
        props;
                            ...
                            {bookingIds.map((id) => {
                                ...
                                return (
                                    <BookingCard
                                        ...
                                        statusDisabled={!!props.lockedStatusIds?.has(id)}
